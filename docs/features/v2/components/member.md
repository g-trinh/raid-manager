...
| Skill     | int    | Ability to perform the role correctly, on a 0-100 scale |
| Liability | int    | Ability to respect boss mechanics correctly, on a 0-100 scale |
...
- Skill and Liability are the only encounter stats in the MVP
